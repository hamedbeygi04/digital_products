# Generated by Django 5.2 on 2025-06-02 15:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(0, 'Void'), (10, 'Paid'), (20, 'Error'), (30, 'Cancelled'), (31, 'Refunded')], db_index=True, default=0, verbose_name='status')),
                ('device_uuid', models.CharField(blank=True, max_length=40, verbose_name='device uuid')),
                ('token', models.CharField()),
                ('phone_number', models.CharField(blank=True, validators=[utils.validators.PhoneNumberValidator()], verbose_name='phone number')),
